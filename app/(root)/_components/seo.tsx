      ...
      <section className="md:mb-24 mb-10">
        <div className="container mx-auto ">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
            <div className="border border-gray-200 hover:border-pink-500 sm:py-8  py-5 lg:px-8 sm:px-10 px-4 rounded-3xl hover:border-gradient-to-r from-pink-500 to-purple-600">
              <h1 className="heading py-4 ">
                Innovative Web Solutions for Digital Age
              </h1>

              <p className="desc mt-3">
                What sets us apart is our commitment to innovation. We believe
                in staying ahead of the curve, constantly exploring new
                technologies, design trends, and digital marketing strategies.
                Our team of skilled designers, developers, and strategists work
                together to create web solutions that not only meet current
                standards but also anticipate future needs. With our guidance,
                your online presence will always be at the forefront of
                innovation.
              </p>
              <p className="desc mt-3">
            ...
            <div className="border border-gray-200 hover:border-pink-500 sm:py-8  py-5 lg:px-8 sm:px-10 px-4 rounded-3xl hover:border-gradient-to-r from-pink-500 to-purple-600">
              <h1 className="heading py-4 ">Empowering Your Online Presence</h1>
              ...
              <p className="desc mt-3">
                ...
                and individuals with the digital tools and strategies they need
